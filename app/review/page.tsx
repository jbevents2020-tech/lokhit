...
import { ArrowLeft, CheckCircle2, Clock3, LoaderCircle, Pencil, RefreshCw, Send, XCircle } from "lucide-react";
...
export default function ReviewPage() {
  ...
  async function approve(item: ReviewItem) {
    if (!userId) return;
    if (!item.featured_image_url) { setNotice({ type: "error", text: "Featured Image नसल्यामुळे ही बातमी approve करता येणार नाही. Reporter कडे image जोडण्यासाठी परत पाठवा." }); return; }
